...
package BaseParameters
  model BaseParameters
    ...
    parameter Modelica.SIunits.DynamicViscosity mu_Water = 0.001 "Dynamic viscosity of water" annotation(Dialog(tab = "Substance Properties", group = "Water"));
    ...
    parameter Modelica.SIunits.Temperature T0 = 293.15 "Initial temperature" annotation(Dialog(tab = "Initialization"));
