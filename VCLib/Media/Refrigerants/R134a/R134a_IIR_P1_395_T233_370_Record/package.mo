within VCLib.Media.Refrigerants.R134a;
package R134a_IIR_P1_395_T233_370_Record "Refrigerant model for R134a using a hybrid approach with recods"
  ...
  redeclare record EoS
    ...
    extends DataBase.Media.Refrigerants.R134a.EoS_IIR_P1_395_T233_370;
  end EoS;

  redeclare record BDSP
    "Record that contains fitting coefficients of the state properties at
    bubble and dew lines"
    extends DataBase.Media.Refrigerants.R134a.BDSP_IIR_P1_395_T233_370;
  end BDSP;
  ...
  redeclare record TSP
    ...
    extends DataBase.Media.Refrigerants.R134a.TSP_IIR_P1_395_T233_370;
  end TSP;
