...
partial package PartialHybridTwoPhaseMediumRecord "Base class for two phase medium using a hybrid approach with records"
  extends
  ...
  replaceable record EoS
    ...
    extends
    DataBase.Media.Refrigerants.HelmholtzEquationOfStateBaseDateDefinition;
  end EoS;
  ...
  replaceable record BDSP
    ...
    extends
    DataBase.Media.Refrigerants.BubbleDewStatePropertiesBaseDataDefinition;
  end BDSP;
  ...
  replaceable record TSP
    ...
    extends
    DataBase.Media.Refrigerants.ThermodynamicStatePropertiesBaseDataDefinition;
  end TSP;
