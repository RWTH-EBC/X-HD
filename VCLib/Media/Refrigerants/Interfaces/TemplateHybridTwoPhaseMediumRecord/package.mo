within VCLib.Media.Refrigerants.Interfaces;
partial package TemplateHybridTwoPhaseMediumRecord "Template for media models using a hybrid approach with records"
...
extends VCLib.Media.Refrigerants.Interfaces.PartialHybridTwoPhaseMediumRecord(
  mediumName="Name",
  substanceNames={"Name"},
  singleState=false,
  SpecificEnthalpy(
  ...
  redeclare record EoS
    ...
    extends DataBase.Media.Refrigerants.R290.EoS_IIR_P05_30_T263_343;
  end EoS;

  redeclare record BDSP "Record that contains fitting coefficients of the
    state properties at bubble and dew lines"
    extends DataBase.Media.Refrigerants.R290.BDSP_IIR_P05_30_T263_343;
  end BDSP;
  ...
  redeclare record TSP "Record that contains fitting coefficients of the
    ...
    extends DataBase.Media.Refrigerants.R290.TSP_IIR_P05_30_T263_343;
  end TSP;
