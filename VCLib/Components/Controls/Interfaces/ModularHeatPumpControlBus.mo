within VCLib.Components.Controls.Interfaces;
expandable connector ModularHeatPumpControlBus
  ...
  //
  parameter AixLib.Controls.Types.heatPumpMode mode=AixLib.Controls.Types.heatPumpMode.heatPump
  ...
  //
  AixLib.Controls.Interfaces.ModularExpansionValveControlBus expValBus(final
      nValCon=nVal)
    "Bus that contains all relevant connections for modular expansion valves";
  AixLib.Controls.Interfaces.ModularCompressorControlBus comBus(final
      nComCon=nCom)
    "Bus that contains all relevant connections for modular compressors";
  AixLib.Controls.Interfaces.ModularSensorControlBus senBus(
    final nValSen=nVal,
    final nEvaSen=nEva,
    final nComSen=nCom,
    final nConSen=nCon)
