within VCLib.Components.Controls.HeatPump.ModularHeatPumps.BaseClasses;
partial model PartialModularController
  ...
  //
  AixLib.Controls.Continuous.LimPID intCon[nCom](
  ...
  AixLib.Controls.Interfaces.ModularHeatPumpControlBus dataBus
    "Data bus with control signals" annotation (Placement(
