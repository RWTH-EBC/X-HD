within VCLib.Components.ExpansionValves.ModularExpansionValves;
model ModularExpansionValvesSensors "Model of modular expansion valves, i.g. each valves is in front 
  ...
  //
  VCLib.Components.Sensors.ModularSensors modularSensors(
...
equation
  ...
  //
  connect(modularSensors.meaPre, dataBus.senBus.meaPreVal)
    annotation (Line(points={{34,-10},{34,-90},{0.05,-90},{0.05,-99.95}},
                color={0,0,127}));
  connect(modularSensors.meaTem, dataBus.senBus.meaTemVal)
    annotation (Line(points={{38,-10},{38,-90},{0.05,-90},{0.05,-99.95}},
                color={0,0,127}));
  connect(modularSensors.meaMasFlo, dataBus.senBus.meaMasFloVal)
    annotation (Line(points={{42,-10},{42,-90},{0.05,-90},{0.05,-99.95}},
                color={0,0,127}));
  connect(modularSensors.meaQua, dataBus.senBus.meaPhaVal)
