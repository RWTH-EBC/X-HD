within VCLib.Components.ExpansionValves.BaseClasses;
partial model PartialModularExpansionVavles
  ...
  */
  ...
  //
  extends Components.Interfaces.PartialModularPort_b(redeclare replaceable
      package Medium = Modelica.Media.R134a.R134a_ph, final nPorts=nVal);
  ...
  //
  AixLib.Controls.Interfaces.ModularHeatPumpControlBus dataBus(final nVal=nVal)
    "Data bus connector"
