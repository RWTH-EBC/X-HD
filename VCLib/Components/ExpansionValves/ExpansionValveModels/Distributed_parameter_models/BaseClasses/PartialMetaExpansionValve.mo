...
partial model PartialMetaExpansionValve
  ...
  parameter
    VCLib.Components.ExpansionValves.ExpansionValveModels.Distributed_parameter_models.Utilities.Types.CalcProc
    calcProc=VCLib.Components.ExpansionValves.ExpansionValveModels.Distributed_parameter_models.Utilities.Types.CalcProc.nominal
  ...
  parameter Modelica.Units.SI.MassFlowRate mFlowNom=m_flow_nominal
    "Mass flow at nominal conditions" annotation (Dialog(
      ...
      enable=if ((calcProc == VCLib.Components.ExpansionValves.ExpansionValveModels.Distributed_parameter_models.Utilities.Types.CalcProc.nominal)
           or (calcProc == VCLib.Components.ExpansionValves.ExpansionValveModels.Distributed_parameter_models.Utilities.Types.CalcProc.flowCoefficient))
  ...
  replaceable model FlowCoefficient =
    VCLib.Components.ExpansionValves.ExpansionValveModels.Distributed_parameter_models.Utilities.FlowCoefficient.SpecifiedFlowCoefficients.ConstantFlowCoefficient
...
replaceable model MetastabilityCoefficient =
   ExpansionValveModels.Distributed_parameter_models.Utilities.MetastabilityCoefficient.SpecifiedMetastabilityCoefficient.ConMetaCoeff
  ...
  /*extends AixLib.Fluid.Interfaces.PartialTwoPortTransport(
    ...
    extends
    WorkingVersion_BSA_Libtest.Fluid.VaporCompressionCycles.Utilities.Interfaces.PartialTwoPortTransport(
    redeclare replaceable package Medium =
