within VCLib.Components.ExpansionValves.ExpansionValveModels.Distributed_parameter_models.BaseClasses.Coefficient;
partial model PartialMetastabilityCoefficient
  ...
  Modelica.Units.SI.AbsolutePressure p_th "Pressure at the throat";
