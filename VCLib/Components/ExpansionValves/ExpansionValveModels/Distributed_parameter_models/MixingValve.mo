...
model MixingValve
  ...
  outer VCLib.Components.ExpansionValve.Models.Utilities.BaseParameters baseParameters
  ...
  parameter Real leakageOpening(min=0,max=1)=1e-3
    ...
    //Valves                                                                 //
    ///////////////////////////////////////////////////////////////////////////
  VCLib.Components.ExpansionValves.ExpansionValveModels.Distributed_parameter_models.SimpleValve
    Valve(
    Kvs=Kvs,
    m_flow_small=1e-4,
