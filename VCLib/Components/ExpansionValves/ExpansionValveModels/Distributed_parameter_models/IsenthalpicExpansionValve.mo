...
model IsenthalpicExpansionValve
  "Model of a simple isenthalpic expansion valve"
  import WorkingVersion_BSA_Libtest;
  extends
    ExpansionValveModels.Distributed_parameter_models.BaseClasses.PartialIsenthalpicExpansionValve;
