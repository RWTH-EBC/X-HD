within VCLib.Components.ExpansionValves.ExpansionValveModels.Distributed_parameter_models.Utilities.MetastabilityCoefficient;
model PowerMetastabilityCoefficient
  ...
  extends
    ExpansionValveModels.Distributed_parameter_models.BaseClasses.Coefficient.PartialMetastabilityCoefficient;
...
"Chose predefinied power model for Metastability parameter";*/
  ...
  Modelica.Units.SI.Diameter dThr=opening*dInlPip;

  Modelica.Units.SI.Diameter d_e=dInlPip - dThr;
  ...
  */
  Modelica.Units.SI.AbsolutePressure p_th "Pressure at throat Valve";
