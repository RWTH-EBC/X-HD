within VCLib.Components.ExpansionValves.ExpansionValveModels.Distributed_parameter_models.Utilities.FlowCoefficient;
model PolynomialFlowCoefficient
  ...
  extends
    ExpansionValveModels.Distributed_parameter_models.BaseClasses.Coefficient.PartialFlowCoefficient;
