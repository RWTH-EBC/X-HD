...
model EquilibriumExpansionValve
  ...
  import WorkingVersion_BSA_Libtest;
  ...
  Modelica.Units.SI.Pressure p_t "Throat Pressure";
  Modelica.Units.SI.Temperature T_tv "Throat vapor temperature";
  Modelica.Units.SI.SpecificVolume v_tv "Throat vapor specific volume";
    Real kappa "Isentropic exponent";
  Modelica.Units.SI.Temperature TInl "Temperature at inlet of valve";
  Modelica.Units.SI.SpecificEnthalpy h_t "Specific enthalpie at throat";
    Real x_inl "vapor quality at inlet";
  Modelica.Units.SI.MassFlowRate m_FFM "Frozen flow Model mass flow rate";
  Modelica.Units.SI.MassFlowRate m_HEN "Equlibirum flow Model mass flow rate";
