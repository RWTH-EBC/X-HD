...
<ul>
  ...
  (see <a href=\"https://github.com/RWTH-EBC/AixLib/issues/467\">issue 467</a>).
    ...
    <li>
    March, 2019, by Stephan Goebel:<br/>
    Additional detailed reciprocating compressor model
    </li>
        <li>
    August, 2019, by Christian Schwenzer:<br/>
    Additional detailed rolling type piston compressor model
    </li>
            <li>
