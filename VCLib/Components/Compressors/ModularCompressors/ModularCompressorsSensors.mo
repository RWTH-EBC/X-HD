within VCLib.Components.Compressors.ModularCompressors;
model ModularCompressorsSensors
  ...
  //
  Components.Sensors.ModularSensors modSen(
...
equation
  ...
  connect(modSen.meaMasFlo, dataBus.senBus.meaMasFloCom)
    annotation (Line(points={{40,-10},{40,-10},{40,-22},{40,-90},{0.05,
          -90},{0.05,-99.95}}, color={0,0,127}));
