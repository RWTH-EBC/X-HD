within VCLib.Components.Compressors.SimpleCompressors.RotaryCompressors;
model RotaryCompressorPressureLosses
  ...
  //
  AixLib.Fluid.FixedResistances.HydraulicResistance hydResInl(
  ...
  AixLib.Fluid.FixedResistances.HydraulicResistance hydResOut(
    redeclare final package Medium = Medium,
    final zeta=zetOut,
