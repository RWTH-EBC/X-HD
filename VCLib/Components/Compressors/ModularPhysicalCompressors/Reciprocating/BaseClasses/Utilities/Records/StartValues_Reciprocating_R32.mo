...
record StartValues_Reciprocating_R32
  ...
  Modelica.Units.SI.Pressure p_gas(start=40e5) "Pressure inside the chamber";
  Modelica.Units.SI.SpecificInternalEnergy u_gas(start=500e3);
  Modelica.Units.SI.SpecificEnthalpy h_gas(start=550e3);
...
end StartValues_Reciprocating_R32;
