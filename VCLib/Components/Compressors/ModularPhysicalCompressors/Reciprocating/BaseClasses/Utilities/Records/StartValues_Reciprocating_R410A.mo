...
record StartValues_Reciprocating_R410A
  ...
  Modelica.Units.SI.SpecificInternalEnergy u_gas(start=450e3);
  Modelica.Units.SI.SpecificEnthalpy h_gas(start=500e3);
  VCLib.Components.Compressors.ModularPhysicalCompressors.Reciprocating.BaseClasses.Medium.ThermodynamicState
    state_dh;
  VCLib.Components.Compressors.ModularPhysicalCompressors.Reciprocating.BaseClasses.Medium.ThermodynamicState
    state_in;
  //Mass
  Modelica.Units.SI.Mass m_gas(start=2e-4);
  ...
  Real G_dot_out(min=1) "Mass flow density at valve outlet";
  annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
        coordinateSystem(preserveAspectRatio=false)));
end StartValues_Reciprocating_R410A;
