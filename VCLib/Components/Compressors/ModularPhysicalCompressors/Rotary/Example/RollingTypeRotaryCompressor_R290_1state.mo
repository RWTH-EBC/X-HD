...
model RollingTypeRotaryCompressor_R290_1state
  "Compressor Model using Refrigerant R290"
  parameter Modelica.Media.Interfaces.Types.Temperature T_evap=253.15;
  parameter Modelica.Media.Interfaces.Types.AbsolutePressure p_cond=4e5
    "Condenser Boundary pressure";
  parameter Modelica.Media.Interfaces.Types.AbsolutePressure p_evap=2e5;
  ...
  Modelica.Thermal.HeatTransfer.Components.HeatCapacitor CompressorWall(     T(
        ...
        rotation=90,
        origin={-66,-84})));
  Utilities.Compression_R290 piston1(m(start=5e-5), p(start=5000000))
...
end RollingTypeRotaryCompressor_R290_1state;
