...
model RollingTypeRotaryCompressor_R32_2states
  ...
  T(displayUnit="degC") = 373.15,
    nPorts=2,
    p=4878600)                      annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=180,
        origin={88,0})));
  ...
  Modelica.Thermal.HeatTransfer.Components.ThermalConductor thermalConductor_ambient(G=G)
    "Thermal conduction between cylinder and ambient" annotation (Placement(
        ...
        rotation=0,
        origin={52,-90})));
  Utilities.Compression_R32_old piston1
    annotation (Placement(transformation(extent={{16,-12},{36,8}})));
  Utilities.Compression_R32_old piston2
...
end RollingTypeRotaryCompressor_R32_2states;
