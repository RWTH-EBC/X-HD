...
model RollingTypeRotaryCompressor_R134a_1state
  "Compressor Model using Refrigerant R134a"
  parameter Modelica.Media.Interfaces.Types.Temperature T_evap=273.15;
  parameter Modelica.Media.Interfaces.Types.AbsolutePressure p_cond=800000
  ...
  Modelica.Thermal.HeatTransfer.Components.HeatCapacitor CompressorWall(T(start=
        ...
        rotation=90,
        origin={-66,-84})));
  Utilities.Compression_R134a piston1(
    a_co=9e-3,
    m(start=5e-4),
    p(start=300000))
...
equation
  ...
  annotation (
    ...
    experiment(
      ...
      Interval=0.001,
      __Dymola_Algorithm=""));
end RollingTypeRotaryCompressor_R134a_1state;
