...
model Compression_R744_old
  ...
  SpecificInternalEnergy u(start=50e3) "specific internal energy of gas";
  ...
  SpecificEnthalpy h(start=529249) "Specific enthalpy of gas";
  ...
  Pressure p(start=10e5, max=700e5) "Pressure in compressor";
...
equation
  ...
  A_dis_cor = smooth(1, if der(m_out) < m_out_avg then 9e-2*G_dot_out^(-1.3)
     else A_dis);
