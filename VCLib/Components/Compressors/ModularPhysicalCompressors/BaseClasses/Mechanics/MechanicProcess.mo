...
model MechanicProcess
  ...
  parameter Modelica.Units.SI.Radius r_ShaJouBea=1.15E-2 "radius of shaft"
    annotation (Dialog(tab="Journal Bearing", group="Geometry"));
  parameter Modelica.Units.SI.Distance delta=1E-3 "clearance"
    annotation (Dialog(tab="Journal Bearing", group="Geometry"));
  parameter Modelica.Units.SI.Height hjoubea=2E-3 "height of journal bearing"
    annotation (Dialog(tab="Journal Bearing", group="Geometry"));
  parameter Real my=0.01 "coefficient of friction at journal bearing"
  annotation(Dialog(tab="Journal Bearing",group="Others"));

  parameter Modelica.Units.SI.Radius r_ThrBea=3.3E-2 "Radius of thrust bearing"
    annotation (Dialog(tab="Thrust Bearing", group="Geometry"));
  parameter Modelica.Units.SI.Radius r_ShaThrBea=1.15E-2
