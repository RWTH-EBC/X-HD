within VCLib.Components.HeatExchangers.MovingBoundaryHeatExchangers.Validation.SecondaryFluidCells;
model CounterCurrentHeatExchanger "Validation model of a secondary fluid cell working in counter-current 
  ...
  parameter Modelica.Units.SI.AbsolutePressure pOut=1.101325e5
  ...
  Modelica.Blocks.Sources.Sine lenInp[3](
    each f=1/12.5,
    each offset=2/3,
    each amplitude=1/6) "Provide lengths of different regimes"
