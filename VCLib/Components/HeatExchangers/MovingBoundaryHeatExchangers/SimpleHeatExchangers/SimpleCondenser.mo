within VCLib.Components.HeatExchangers.MovingBoundaryHeatExchangers.SimpleHeatExchangers;
model SimpleCondenser "Model of a simple finite volume condenser"
  extends BaseClasses.PartialSimpleHeatExchanger(
    final appHX=Utilities.Types.ApplicationHX.Condenser,
    redeclare final model MovBouCel =
        Utilities.FluidCells.CondenserCell,
    ...
    redeclare final model SecFluMod =
