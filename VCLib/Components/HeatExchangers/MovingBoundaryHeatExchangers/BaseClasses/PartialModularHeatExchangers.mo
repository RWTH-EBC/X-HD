...
partial model PartialModularHeatExchangers
  ...
  parameter Modelica.Units.SI.SpecificEnthalpy dhMin_SCTPSH_SCTP[nHeaExc]=fill(
      5, nHeaExc)
    "Threshold specific enthalpy of switching condition SCTPSH to SCTP"
    annotation (Dialog(tab="Guard", group="Specific enthalpy"));
  parameter Modelica.Units.SI.SpecificEnthalpy dhMin_SCTPSH_TPSH[nHeaExc]=fill(
      5, nHeaExc)
    "Threshold specific enthalpy of switching condition SCTPSH to TPSH"
    annotation (Dialog(tab="Guard", group="Specific enthalpy"));
  parameter Modelica.Units.SI.SpecificEnthalpy dhMin_SCTP_SCTPSH[nHeaExc]=fill(
      5, nHeaExc)
    "Threshold specific enthalpy of switching condition SCTP to SCTPSH"
    annotation (Dialog(tab="Guard", group="Specific enthalpy"));
  parameter Modelica.Units.SI.SpecificEnthalpy dhMin_SCTP_SC[nHeaExc]=fill(5,
      nHeaExc) "Threshold specific enthalpy of switching condition SCTP to SC"
    annotation (Dialog(tab="Guard", group="Specific enthalpy"));
  parameter Modelica.Units.SI.SpecificEnthalpy dhMin_SCTP_TP[nHeaExc]=fill(5,
      nHeaExc) "Threshold specific enthalpy of switching condition SCTP to TP"
    annotation (Dialog(tab="Guard", group="Specific enthalpy"));
  parameter Modelica.Units.SI.SpecificEnthalpy dhMin_TPSH_SCTPSH[nHeaExc]=fill(
      5, nHeaExc)
    "Threshold specific enthalpy of switching condition TPSH to SCTPSH"
    annotation (Dialog(tab="Guard", group="Specific enthalpy"));
  parameter Modelica.Units.SI.SpecificEnthalpy dhMin_TPSH_TP[nHeaExc]=fill(5,
      nHeaExc) "Threshold specific enthalpy of switching condition TPSH to TP"
    annotation (Dialog(tab="Guard", group="Specific enthalpy"));
  parameter Modelica.Units.SI.SpecificEnthalpy dhMin_TPSH_SH[nHeaExc]=fill(5,
      nHeaExc) "Threshold specific enthalpy of switching condition TPSH to SH"
    annotation (Dialog(tab="Guard", group="Specific enthalpy"));
  parameter Modelica.Units.SI.SpecificEnthalpy dhMin_SC_SCTP[nHeaExc]=fill(5,
      nHeaExc) "Threshold specific enthalpy of switching condition SC to SCTP"
    annotation (Dialog(tab="Guard", group="Specific enthalpy"));
  parameter Modelica.Units.SI.SpecificEnthalpy dhMin_TP_SCTP[nHeaExc]=fill(5,
      nHeaExc) "Threshold specific enthalpy of switching condition TP to SCTP"
    annotation (Dialog(tab="Guard", group="Specific enthalpy"));
  parameter Modelica.Units.SI.SpecificEnthalpy dhMin_TP_TPSH[nHeaExc]=fill(5,
      nHeaExc) "Threshold specific enthalpy of switching condition TP to TPSH"
    annotation (Dialog(tab="Guard", group="Specific enthalpy"));
  parameter Modelica.Units.SI.SpecificEnthalpy dhMin_SH_TPSH[nHeaExc]=fill(5,
      nHeaExc) "Threshold specific enthalpy of switching condition SH to TPSH"
    annotation (Dialog(tab="Guard", group="Specific enthalpy"));
  ...
  parameter Modelica.Units.SI.CoefficientOfHeatTransfer AlpSCPri[nHeaExc]=fill(
      2000, nHeaExc) "Effective coefficient of heat transfer between the wall and fluid of the
    supercooled regime" annotation (Dialog(
      tab="Moving boundary",
      group="Heat transfer",
      enable=not useHeaCoeModPri));
  parameter Modelica.Units.SI.CoefficientOfHeatTransfer AlpTPPri[nHeaExc]=fill(
      7500, nHeaExc) "Effective coefficient of heat transfer between the wall and fluid of the
    two-phase regime" annotation (Dialog(
      tab="Moving boundary",
      group="Heat transfer",
      enable=not useHeaCoeModPri));
  parameter Modelica.Units.SI.CoefficientOfHeatTransfer AlpSHPri[nHeaExc]=fill(
      2500, nHeaExc) "Effective coefficient of heat transfer between the wall and fluid of the
