...
partial model PartialGuard
  ...
  input Modelica.Units.SI.Temperature TWalTP
    "Temperature of the wall of the two-phase regime"
    annotation (Dialog(tab="General", group="Inputs"));
  input Modelica.Units.SI.SpecificEnthalpy hOutEva
    "Specific enthalpy at inlet of design direction"
    annotation (Dialog(tab="General", group="Inputs"));
  input Modelica.Units.SI.SpecificEnthalpy hOutCon
    "Specific enthalpy at out of design direction"
    annotation (Dialog(tab="General", group="Inputs"));
  input Modelica.Units.SI.SpecificEnthalpy hLiq
    "Specific enthalpy at bubble line"
    annotation (Dialog(tab="General", group="Inputs"));
  input Modelica.Units.SI.SpecificEnthalpy hVap "Specific enthalpy at dew line"
    annotation (Dialog(tab="General", group="Inputs"));
  ...
  //
  discrete Modelica.Units.SI.Temperature TWalTPIni
    "Values used for reinitialisation of TWalTP";
  discrete Modelica.Units.SI.SpecificEnthalpy hOutEvaIni
    "Values used for reinitialisation of hOutEvaDes";
  discrete Modelica.Units.SI.SpecificEnthalpy hOutConIni
    "Values used for reinitialisation of hOutConDes";
  discrete Modelica.Units.SI.SpecificEnthalpy hSCTPIni
    "Values used for reinitialisation of hSCTP";
  discrete Modelica.Units.SI.SpecificEnthalpy hTPSHIni
