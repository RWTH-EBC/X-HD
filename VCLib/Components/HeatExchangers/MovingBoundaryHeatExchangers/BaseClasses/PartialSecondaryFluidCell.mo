...
partial model PartialSecondaryFluidCell
  ...
  parameter Modelica.Units.SI.CoefficientOfHeatTransfer AlpSC=100 "Effective coefficient of heat transfer between the wall and fluid of the
    supercooled regime" annotation (Dialog(
      tab="Heat transfer",
      group="Heat transfer coefficient",
      enable=not useHeaCoeMod));
  parameter Modelica.Units.SI.CoefficientOfHeatTransfer AlpTP=100 "Effective coefficient of heat transfer between the wall and fluid of the
    two-phase regime" annotation (Dialog(
      tab="Heat transfer",
      group="Heat transfer coefficient",
      enable=not useHeaCoeMod));
  parameter Modelica.Units.SI.CoefficientOfHeatTransfer AlpSH=100 "Effective coefficient of heat transfer between the wall and fluid of the
  ...
  parameter Modelica.Units.SI.Temperature TSCIni=293.15
    "Temperature of supercooled regime at initialisation" annotation (Dialog(
      tab="Advanced",
      group="Initialisation",
      enable=not iniSteSta));
  parameter Modelica.Units.SI.Temperature TTPIni=293.15
    "Temperature of two-phase regime at initialisation" annotation (Dialog(
      tab="Advanced",
      group="Initialisation",
      enable=not iniSteSta));
  parameter Modelica.Units.SI.Temperature TSHIni=293.15
    "Temperature of superheated regime at initialisation" annotation (Dialog(
      tab="Advanced",
      group="Initialisation",
      enable=not iniSteSta));
...
protected
  ...
  Modelica.Units.SI.Temperature TInlDes=Medium.temperature(InlDes)
    "Temperature at the inlet of design direction";
  Modelica.Units.SI.Temperature TSC "Temperature of the supercooled regime";
  Modelica.Units.SI.Temperature TTP "Temperature of the two-phase regime";
  Modelica.Units.SI.Temperature TSH "Temperature of the superheated regime";
  Modelica.Units.SI.Temperature TInlRev=Medium.temperature(InlRev)
    "Temperature at the inlet of reverse direction";
  Modelica.Units.SI.SpecificEnthalpy hSC=Medium.specificEnthalpy(SC)
    "Specific enthalpy of the supercooled regime";
  Modelica.Units.SI.SpecificEnthalpy hTP=Medium.specificEnthalpy(TP)
    "Specific enthalpy of the two-phase regime";
  Modelica.Units.SI.SpecificEnthalpy hSH=Medium.specificEnthalpy(SH)
    "Specific enthalpy of the superheated regime";
  Modelica.Units.SI.Density dSC=Medium.density(SC)
    "Density of the supercooled regime";
  Modelica.Units.SI.Density dTP=Medium.density(TP)
    "Density of the two-phase regime";
  Modelica.Units.SI.Density dSH=Medium.density(SH)
...
public
  ...
  Modelica.Units.SI.MassFlowRate m_flow_SCTP "Mass flow rate flowing out of the supercooled regime and into the two-phase
    regime";
  Modelica.Units.SI.MassFlowRate m_flow_TPSH "Mass flow rate flowing out of the two-phase regime and into the superheated
    regime";

  Modelica.Units.SI.Mass mSC "Mass of the supercooled regime";
  Modelica.Units.SI.Mass mTP "Mass of the two-phase regime";
  Modelica.Units.SI.Mass mSH "Mass of the superheated regime";

  Modelica.Units.SI.SpecificHeatCapacity cpSC=Medium.specificHeatCapacityCp(SC)
    "Density of the supercooled regime";
  Modelica.Units.SI.SpecificHeatCapacity cpTP=Medium.specificHeatCapacityCp(TP)
    "Density of the two-phase regime";
