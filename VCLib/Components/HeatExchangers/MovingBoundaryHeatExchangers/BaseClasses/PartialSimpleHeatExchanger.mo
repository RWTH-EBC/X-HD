...
partial model PartialSimpleHeatExchanger
  ...
  parameter Modelica.Units.SI.CoefficientOfHeatTransfer AlpSCPri=2000 "Effective coefficient of heat transfer between the wall and fluid of the
    supercooled regime" annotation (Dialog(
      tab="Moving boundary",
      group="Heat transfer",
      enable=not useHeaCoeModPri));
  parameter Modelica.Units.SI.CoefficientOfHeatTransfer AlpTPPri=7500 "Effective coefficient of heat transfer between the wall and fluid of the
    two-phase regime" annotation (Dialog(
      tab="Moving boundary",
      group="Heat transfer",
      enable=not useHeaCoeModPri));
  parameter Modelica.Units.SI.CoefficientOfHeatTransfer AlpSHPri=2500 "Effective coefficient of heat transfer between the wall and fluid of the
  ...
  parameter Modelica.Units.SI.CoefficientOfHeatTransfer AlpSCSec=100 "Effective coefficient of heat transfer between the wall and fluid of the
    supercooled regime" annotation (Dialog(
      tab="Secondary fluid",
      group="Heat transfer",
      enable=not useHeaCoeModSec));
  parameter Modelica.Units.SI.CoefficientOfHeatTransfer AlpTPSec=100 "Effective coefficient of heat transfer between the wall and fluid of the
    two-phase regime" annotation (Dialog(
      tab="Secondary fluid",
      group="Heat transfer",
      enable=not useHeaCoeModSec));
  parameter Modelica.Units.SI.CoefficientOfHeatTransfer AlpSHSec=100 "Effective coefficient of heat transfer between the wall and fluid of the
    superheated regime" annotation (Dialog(
      tab="Secondary fluid",
      group="Heat transfer",
      enable=not useHeaCoeModSec));
  ...
  parameter Modelica.Units.SI.Temperature TSCIniWal=293.15
    "Temperature of supercooled regime at initialisation"
    annotation (Dialog(tab="Advanced", group="Initialisation wall"));
  parameter Modelica.Units.SI.Temperature TTPIniWal=293.15
    "Temperature of two-phase regime at initialisation"
    annotation (Dialog(tab="Advanced", group="Initialisation wall"));
  parameter Modelica.Units.SI.Temperature TSHIniWal=293.15
  ...
  parameter Modelica.Units.SI.Temperature TSCIniSec=293.15
    "Temperature of supercooled regime at initialisation"
    annotation (Dialog(tab="Advanced", group="Initialisation secondary"));
  parameter Modelica.Units.SI.Temperature TTPIniSec=293.15
    "Temperature of two-phase regime at initialisation"
    annotation (Dialog(tab="Advanced", group="Initialisation secondary"));
  parameter Modelica.Units.SI.Temperature TSHIniSec=293.15
    "Temperature of superheated regime at initialisation"
    annotation (Dialog(tab="Advanced", group="Initialisation secondary"));
  ...
  parameter Real tauVoiFra=125
    ...
    changes"
    annotation (Dialog(tab="Advanced", group="Convergence"));
  parameter Modelica.Units.SI.Frequency tauTem=1
