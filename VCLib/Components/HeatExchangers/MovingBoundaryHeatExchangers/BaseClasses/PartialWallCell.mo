...
partial model PartialWallCell
  ...
  Modelica.Units.SI.Temperature TSCTP "Temperature of the wall at the boundary between supercooled and 
    two-phase regime";
  Modelica.Units.SI.Temperature TTP
    "Average temperature of the wall of the two-phase regime";
  Modelica.Units.SI.Temperature TTPSH "Temperature of the wall at the boundary between two-phase and 
    superheated regime";
  Modelica.Units.SI.Temperature TSH
    "Average temperature of the wall of the superheated regime";

  // Defitinion of variables describing heat flows
  //
  Modelica.Units.SI.HeatFlowRate Q_flow_SCPri "Heat flow rate between the supercooled regime and the wall of the 
    primary fluid";
  Modelica.Units.SI.HeatFlowRate Q_flow_TPPri "Heat flow rate between the two-phase regime and the wall of the 
    primary fluid";
  Modelica.Units.SI.HeatFlowRate Q_flow_SHPri "Heat flow rate between the superheated regime and the wall of the 
    primary fluid";

  Modelica.Units.SI.HeatFlowRate Q_flow_SCSec "Heat flow rate between the supercooled regime and the wall of the 
    secondary fluid";
  Modelica.Units.SI.HeatFlowRate Q_flow_TPSec "Heat flow rate between the two-phase regime and the wall of the 
    secondary fluid";
  Modelica.Units.SI.HeatFlowRate Q_flow_SHSec "Heat flow rate between the uperheated regime and the wall of the 
    secondary fluid";
