within VCLib.Components.HeatExchangers.MovingBoundaryHeatExchangers.Utilities.VoidFractions;
model Sangi2015
  ...
  Modelica.Units.SI.Density dLiq=Medium.bubbleDensity(sat=TP)
    "Density at bubble line";
  Modelica.Units.SI.Density dVap=Medium.dewDensity(sat=TP)
    "Density at dew line";
  Modelica.Units.SI.SpecificEnthalpy hLiq=Medium.bubbleEnthalpy(sat=TP)
    "Specific enthalpy at bubble line";
  Modelica.Units.SI.SpecificEnthalpy hVap=Medium.dewEnthalpy(sat=TP)
  ...
  function voidFraction
    "Void fraction at total vaporisation"
      ...
      //
    input Modelica.Units.SI.Density dLiq "Density at bubble line";
    input Modelica.Units.SI.Density dVap "Density at dew line";
