within VCLib.Components.HeatExchangers.MovingBoundaryHeatExchangers.Utilities.HeatTransfers;
model ConstantCoefficientOfHeatTransfer
  ...
  //
  parameter Modelica.Units.SI.CoefficientOfHeatTransfer AlpCon=2000
