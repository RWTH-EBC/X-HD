within VCLib.DataBase.Media.Refrigerants.R134a;
record EoS_IIR_P1_395_T233_370
  "Record with fitting coefficients calculated for first implementation"
  extends
    VCLib.DataBase.Media.Refrigerants.HelmholtzEquationOfStateBaseDateDefinition(
    ...
    f_IdgE2={0},
    f_ResNp=8,
    f_ResP1={0.05586817,0.498223,0.02458698,0.0008570145,0.0004788584,-1.800808,
        0.2671641,-0.04781652},
    f_ResP2={2,1,3,6,6,1,1,2},
    f_ResP3={-0.5,0,0,0,1.5,1.5,2,2},
    f_ResNb=13,
    f_ResB1={0.01423987,0.3324062,-0.007485907,0.0001017263,-0.5184567,-0.08692288,
        0.2057144,-0.005000457,0.0004603262,-0.003497836,0.006995038,-0.01452184,
        -0.0001285458},
